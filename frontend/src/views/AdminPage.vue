<template>
  <div class="admin-page">
      ...
      <TabPanel header="Отзывы">
        ...
        >
          ...
          <Column header="Игра" style="width: 150px">
            <template #body="{ data }">
              <img
                v-if="data.game?.cover_image_path"
                :src="data.game.cover_image_path"
                class="cover-thumb mr-2"
              />
    ...
    />
    <ConfirmDialog v-model:visible="deleteDialogVisible" @confirm="deleteItem" />
  </div>
</template>
...
const openCoverDialog = (g) => {
  editingGameCover.value = g;
  coverDialogVisible.value = true;
};

const confirmDeleteGame = (g) => {
  itemToDelete.value = g;
  deleteType.value = 'game';
